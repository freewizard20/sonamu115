...
function addNotification(){
	...
	mongooseIO.postNotification('매도 및 매수 의뢰 언제든 환영합니다.');
	mongooseIO.postNotification('전화예약 후 방문 부탁드립니다.');
	mongooseIO.postNotification('비공개 매물도 있사오니 전화 문의주십시오.');
	mongooseIO.postNotification('외국어 상담 가능합니다.');
}
